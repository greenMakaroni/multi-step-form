const Step1 = ({ personalInfo, setPersonalInfo }) => {
  ...
  return (
    <div className="text-[black] w-[70%] flex flex-col px-[75px] py-[25px]">
      ...
      <p className="mb-[40px] font-['Ubuntu'] text-[16px] font-[300] text-[#9699ab]"> Please provide your name, email address, and phone number.</p>
      ...
      <form className="flex flex-col justify-between" onSubmit={handleSubmit}>
        ...
        <button className="bg-[#02295a] self-end mt-[14vh] text-[white] font-[500] tracking-wider rounded-lg w-[150px] px-[20px] py-[15px]" type="submit">Next Step</button>
      </form>
    </div>
  )
}
